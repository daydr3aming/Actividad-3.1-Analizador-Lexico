...
static const char *const yytname[] =
{
  ...
  "PRINT", "ASSIGN", "PLUS", "MINUS", "MULT", "DIVISION", "ID", "INUM",
...
{
       1,     2,     3,     9,    10,    11,    12,    13,     4,     5
};

static const yytype_int8 yycheck[] =
{
       3,     4,     5,    11,    11,    11,     0,     7,    11,    12
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 6: /* statement: FLOATDCL ID  */
#line 30 "parser.y"
                              { printf("floatdcl id"); }
#line 1151 "y.tab.c"
    break;

  case 7: /* statement: INTDCL ID  */
#line 31 "parser.y"
                              { printf("intdcl id\n"); }
#line 1157 "y.tab.c"
    break;
...
#line 1163 "y.tab.c"
  ...
  case 9: /* statement: INUM  */
#line 33 "parser.y"
                              { printf("print inum"); }
#line 1169 "y.tab.c"
    break;

  case 10: /* statement: PRINT ID  */
#line 34 "parser.y"
                              { printf("print id\n"); }
#line 1175 "y.tab.c"
    break;
